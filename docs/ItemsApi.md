...
------------- | ------------- | -------------
[**v10_items_get**](ItemsApi.md#v10_items_get) | **GET** /v1.0/items | Get all items
[**v10_items_item_id_delete**](ItemsApi.md#v10_items_item_id_delete) | **DELETE** /v1.0/items/:item_id | Delete item by ID
[**v10_items_item_id_get**](ItemsApi.md#v10_items_item_id_get) | **GET** /v1.0/items/:item_id | Get item by ID
[**v10_items_item_id_put**](ItemsApi.md#v10_items_item_id_put) | **PUT** /v1.0/items/:item_id | Update item by ID
[**v10_items_post**](ItemsApi.md#v10_items_post) | **POST** /v1.0/items | Create an item


# **v10_items_get**
> ItemListResponse v10_items_get(name=name, code=code)
...
with sparkfly_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all items
        api_response = api_instance.v10_items_get(name=name, code=code)
        print("The response of ItemsApi->v10_items_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->v10_items_get: %s\n" % e)
```
...
# **v10_items_item_id_delete**
> v10_items_item_id_delete(item_id)
...
with sparkfly_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete item by ID
        api_instance.v10_items_item_id_delete(item_id)
    except Exception as e:
        print("Exception when calling ItemsApi->v10_items_item_id_delete: %s\n" % e)
```
...
# **v10_items_item_id_get**
> ItemResponse v10_items_item_id_get(item_id)
...
with sparkfly_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get item by ID
        api_response = api_instance.v10_items_item_id_get(item_id)
        print("The response of ItemsApi->v10_items_item_id_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->v10_items_item_id_get: %s\n" % e)
```
...
# **v10_items_item_id_put**
> ItemResponse v10_items_item_id_put(item_id, item_input_request=item_input_request)
...
with sparkfly_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Update item by ID
        api_response = api_instance.v10_items_item_id_put(item_id, item_input_request=item_input_request)
        print("The response of ItemsApi->v10_items_item_id_put:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->v10_items_item_id_put: %s\n" % e)
```
...
# **v10_items_post**
> ItemResponse v10_items_post(item_input_request=item_input_request)
...
with sparkfly_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Create an item
        api_response = api_instance.v10_items_post(item_input_request=item_input_request)
        print("The response of ItemsApi->v10_items_post:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ItemsApi->v10_items_post: %s\n" % e)
```
