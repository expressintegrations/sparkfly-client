...
from sparkfly_client.models.account_level_merchant_report import AccountLevelMerchantReport  # noqa: E501

class TestAccountLevelMerchantReport(unittest.TestCase):
    """AccountLevelMerchantReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountLevelMerchantReport:
        """Test AccountLevelMerchantReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountLevelMerchantReport`
        """
        model = AccountLevelMerchantReport()  # noqa: E501
        if include_optional:
            return AccountLevelMerchantReport(
                data = [
                    sparkfly_client.models.merchant_report.merchant_report(
                        data = [
                            sparkfly_client.models.report_data.report_data(
                                ...
                                business_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                redemption_datetime = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                                impression_datetime = '', 
                                creative = '', 
                                redemption_type = '', 
                                customer_identifier = '', 
                                ...
                                check_number = '', 
                                store_number = '', 
                                offer_activity_id = 56, 
                                qualifying_items = '', 
                                external_offer_instance_id = '', 
                                offer_state_id = '', 
                                loyalty_id = '', )
                            ], 
                        total_redemptions = 56, 
                        total_purchase_amount = 1.337, 
                        average_purchase = 1.337, 
                        average_items_per_transaction = 1.337, 
                        redemptions_by_date = {
                            'key' : ''
                            }, 
                        ...
                        total_purchase_amount_by_location = {
                            'key' : 1.337
                            }, 
                        redemptions_by_merchant = {
                            'key' : 56
                            }, 
                        total_purchase_amount_by_merchant = {
                            'key' : 1.337
                            }, 
                        ...
                        average_items_per_transaction_per_location = {
                            'key' : 1.337
                            }, 
                        average_purchase_by_location = {
                            'key' : 1.337
                            }, 
                        number_of_items = 56, 
                        item_counts = {
    ...
    def testAccountLevelMerchantReport(self):
        """Test AccountLevelMerchantReport"""
