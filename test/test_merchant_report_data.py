...
class TestMerchantReportData(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MerchantReportData:
        """Test MerchantReportData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantReportData`
        """
        model = MerchantReportData()  # noqa: E501
        if include_optional:
    ...
    def testMerchantReportData(self):
        """Test MerchantReportData"""
