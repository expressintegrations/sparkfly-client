...
from sparkfly_client.models.merchant_report import MerchantReport  # noqa: E501

class TestMerchantReport(unittest.TestCase):
    """MerchantReport unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MerchantReport:
        """Test MerchantReport
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MerchantReport`
        """
        model = MerchantReport()  # noqa: E501
        if include_optional:
