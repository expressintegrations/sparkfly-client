...
class Offer(BaseModel):
    ...
    def from_dict(cls, obj: dict) -> Offer:
        ...
        _obj = Offer.parse_obj({
            ...
            "formatting": OfferFormatting.from_dict(obj.get("formatting")) if obj.get("formatting") is not None else None,
            "eligibility": OfferEligibility.from_dict(obj.get("eligibility")) if obj.get("eligibility") is not None else None,
            "redeem_until_depleted": obj.get("redeem_until_depleted"),
            "initial_remaining_value": obj.get("initial_remaining_value")
        })
