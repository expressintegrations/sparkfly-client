...
from sparkfly_client.models.item import Item
...
class ReportData(BaseModel):
    ...
    pos_transaction_id: Optional[StrictStr] = None
    ...
    credential_id: Optional[StrictInt] = None
    ...
    offer_group_id: Optional[StrictInt] = None
    offer_name: Optional[StrictStr] = None
    channel_id: Optional[StrictInt] = None
    channel_group_id: Optional[StrictInt] = None
    channel_group_name: Optional[StrictStr] = None
    channel_name: Optional[StrictStr] = None
    purchase_amount: Optional[StrictInt] = None
    value: Optional[StrictInt] = None
    items: Optional[conlist(StrictStr)] = None
    transaction_items: Optional[conlist(TransactionItem)] = None
    item_groups: Optional[conlist(Item)] = None
    redeemed_items: Optional[conlist(Item)] = None
    impression_ids: Optional[conlist(StrictInt)] = None
    business_date: Optional[datetime] = None
    redemption_datetime: Optional[datetime] = None
    impression_datetime: Optional[StrictStr] = None
    creative: Optional[StrictStr] = None
    redemption_type: Optional[StrictStr] = None
    customer_identifier: Optional[StrictStr] = None
    time_period: Optional[StrictStr] = None
    day_period: Optional[StrictStr] = None
    customer_age: Optional[StrictStr] = None
    customer_frequency: Optional[StrictStr] = None
    customer_gender: Optional[StrictStr] = None
    campaign_id: Optional[StrictStr] = None
    campaign_name: Optional[StrictStr] = None
    check_number: Optional[StrictStr] = None
    store_number: Optional[StrictStr] = None
    offer_activity_id: Optional[StrictInt] = None
    qualifying_items: Optional[StrictStr] = None
    external_offer_instance_id: Optional[StrictStr] = None
    offer_state_id: Optional[StrictStr] = None
    loyalty_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties = ["id", "pos_transaction_id", "operator_id", "merchant_id", "account_id", "member_id", "credential_identifier", "credential_id", "store_id", "store_name", "site_id", "offer_id", "offer_group", "offer_group_id", "offer_name", "channel_id", "channel_group_id", "channel_group_name", "channel_name", "purchase_amount", "value", "items", "transaction_items", "item_groups", "redeemed_items", "impression_ids", "business_date", "redemption_datetime", "impression_datetime", "creative", "redemption_type", "customer_identifier", "time_period", "day_period", "customer_age", "customer_frequency", "customer_gender", "campaign_id", "campaign_name", "check_number", "store_number", "offer_activity_id", "qualifying_items", "external_offer_instance_id", "offer_state_id", "loyalty_id"]
    ...
    def to_dict(self):
        ...
        if self.transaction_items:
            for _item in self.transaction_items:
                if _item:
        ...
        _items = []
        if self.item_groups:
            for _item in self.item_groups:
                if _item:
                    _items.append(_item.to_dict())
            _dict['item_groups'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in redeemed_items (list)
        _items = []
        if self.redeemed_items:
            for _item in self.redeemed_items:
                if _item:
                    _items.append(_item.to_dict())
            _dict['redeemed_items'] = _items
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ReportData:
        """Create an instance of ReportData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ReportData.parse_obj(obj)

        _obj = ReportData.parse_obj({
            "id": obj.get("id"),
            "pos_transaction_id": obj.get("pos_transaction_id"),
            ...
            "offer_group_id": obj.get("offer_group_id"),
            "offer_name": obj.get("offer_name"),
            "channel_id": obj.get("channel_id"),
            "channel_group_id": obj.get("channel_group_id"),
            "channel_group_name": obj.get("channel_group_name"),
            "channel_name": obj.get("channel_name"),
            "purchase_amount": obj.get("purchase_amount"),
            "value": obj.get("value"),
            "items": obj.get("items"),
            "transaction_items": [TransactionItem.from_dict(_item) for _item in obj.get("transaction_items")] if obj.get("transaction_items") is not None else None,
            "item_groups": [Item.from_dict(_item) for _item in obj.get("item_groups")] if obj.get("item_groups") is not None else None,
            "redeemed_items": [Item.from_dict(_item) for _item in obj.get("redeemed_items")] if obj.get("redeemed_items") is not None else None,
            "impression_ids": obj.get("impression_ids"),
            "business_date": obj.get("business_date"),
            "redemption_datetime": obj.get("redemption_datetime"),
            "impression_datetime": obj.get("impression_datetime"),
            "creative": obj.get("creative"),
            "redemption_type": obj.get("redemption_type"),
            "customer_identifier": obj.get("customer_identifier"),
            "time_period": obj.get("time_period"),
            "day_period": obj.get("day_period"),
            "customer_age": obj.get("customer_age"),
            "customer_frequency": obj.get("customer_frequency"),
            "customer_gender": obj.get("customer_gender"),
            "campaign_id": obj.get("campaign_id"),
            "campaign_name": obj.get("campaign_name"),
            "check_number": obj.get("check_number"),
            "store_number": obj.get("store_number"),
            "offer_activity_id": obj.get("offer_activity_id"),
            "qualifying_items": obj.get("qualifying_items"),
            "external_offer_instance_id": obj.get("external_offer_instance_id"),
