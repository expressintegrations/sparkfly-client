...
class ImpressionsApi:
    ...
    @validate_arguments
    def v10_impressions_get(self, **kwargs) -> ImpressionList:  # noqa: E501
        """Get all impressions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_get(async_req=True)
        >>> result = thread.get()
        ...
        :rtype: ImpressionList
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the v10_impressions_get_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.v10_impressions_get_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def v10_impressions_get_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all impressions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ImpressionList, status_code(int), headers(HTTPHeaderDict))
        """
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method v10_impressions_get" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def v10_impressions_impression_id_delete(self, impression_id : Annotated[StrictInt, Field(..., description="The id of the impression")], **kwargs) -> None:  # noqa: E501
        """Delete the impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_impression_id_delete(impression_id, async_req=True)
        >>> result = thread.get()

        :param impression_id: The id of the impression (required)
        :type impression_id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the v10_impressions_impression_id_delete_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.v10_impressions_impression_id_delete_with_http_info(impression_id, **kwargs)  # noqa: E501

    @validate_arguments
    def v10_impressions_impression_id_delete_with_http_info(self, impression_id : Annotated[StrictInt, Field(..., description="The id of the impression")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete the impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_impression_id_delete_with_http_info(impression_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v10_impressions_impression_id_delete" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the path parameters
        _path_params = {}
        if _params['impression_id']:
            _path_params['impression_id'] = _params['impression_id']
    ...
    @validate_arguments
    def v10_impressions_post(self, impression_input_request : Annotated[Optional[ImpressionInputRequest], Field(description="Impression to add to system")] = None, **kwargs) -> ImpressionResponse:  # noqa: E501
        """Creates an impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_post(impression_input_request, async_req=True)
        >>> result = thread.get()

        :param impression_input_request: Impression to add to system
        :type impression_input_request: ImpressionInputRequest
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _request_timeout: timeout setting for this request.
               If one number provided, it will be total request
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: ImpressionResponse
        """
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the v10_impressions_post_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.v10_impressions_post_with_http_info(impression_input_request, **kwargs)  # noqa: E501

    @validate_arguments
    def v10_impressions_post_with_http_info(self, impression_input_request : Annotated[Optional[ImpressionInputRequest], Field(description="Impression to add to system")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Creates an impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.v10_impressions_post_with_http_info(impression_input_request, async_req=True)
        >>> result = thread.get()
        ...
        :return: Returns the result object.
                 If the method is called asynchronously,
                 returns the request thread.
        :rtype: tuple(ImpressionResponse, status_code(int), headers(HTTPHeaderDict))
        """

        _params = locals()

        _all_params = [
            'impression_input_request'
        ]
        _all_params.extend(
            [
                'async_req',
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method v10_impressions_post" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        # process the body parameter
        _body_params = None
        if _params['impression_input_request'] is not None:
            _body_params = _params['impression_input_request']
        ...
        _response_types_map = {
            '201': "ImpressionResponse",
            '400': "BadRequestObject",
            '401': None,
        }

        return self.api_client.call_api(
            '/v1.0/impressions', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
