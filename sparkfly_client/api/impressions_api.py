...
class ImpressionsApi:
    ...
    @validate_arguments
    def create_impression(self, impression_input_request : Annotated[Optional[ImpressionInputRequest], Field(description="Impression to add to system")] = None, **kwargs) -> ImpressionResponse:  # noqa: E501
        """Creates an impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_impression(impression_input_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_impression_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_impression_with_http_info(impression_input_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_impression_with_http_info(self, impression_input_request : Annotated[Optional[ImpressionInputRequest], Field(description="Impression to add to system")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Creates an impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_impression_with_http_info(impression_input_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_impression" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def delete_impression(self, impression_id : Annotated[StrictInt, Field(..., description="The id of the impression")], **kwargs) -> None:  # noqa: E501
        """Delete the impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_impression(impression_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_impression_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_impression_with_http_info(impression_id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_impression_with_http_info(self, impression_id : Annotated[StrictInt, Field(..., description="The id of the impression")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete the impression  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_impression_with_http_info(impression_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_impression" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_impressions(self, **kwargs) -> ImpressionList:  # noqa: E501
        """Get all impressions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_impressions(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_impressions_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_impressions_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_impressions_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all impressions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_impressions_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_impressions" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
