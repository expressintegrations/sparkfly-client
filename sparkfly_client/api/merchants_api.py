...
class MerchantsApi:
    ...
    @validate_arguments
    def create_merchant(self, merchant_input_request : Annotated[Optional[MerchantInputRequest], Field(description="Merchant to add to system")] = None, **kwargs) -> MerchantResponse:  # noqa: E501
        """Create a merchant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_merchant(merchant_input_request, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_merchant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_merchant_with_http_info(merchant_input_request, **kwargs)  # noqa: E501

    @validate_arguments
    def create_merchant_with_http_info(self, merchant_input_request : Annotated[Optional[MerchantInputRequest], Field(description="Merchant to add to system")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Create a merchant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.create_merchant_with_http_info(merchant_input_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method create_merchant" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def delete_merchant(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], **kwargs) -> None:  # noqa: E501
        """Delete merchant by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_merchant(merchant_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_merchant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_merchant_with_http_info(merchant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_merchant_with_http_info(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], **kwargs) -> ApiResponse:  # noqa: E501
        """Delete merchant by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.delete_merchant_with_http_info(merchant_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_merchant" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_merchant(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], **kwargs) -> MerchantResponse:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_merchant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_merchant_with_http_info(merchant_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_merchant_with_http_info(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get merchant by ID  # noqa: E501
    ...
    @validate_arguments
    def get_merchants(self, **kwargs) -> MerchantList:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_merchants_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_merchants_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_merchants_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """Get all merchants  # noqa: E501
    ...
    @validate_arguments
    def update_merchant(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], merchant_input_request : Annotated[Optional[MerchantInputRequest], Field(description="Merchant to update in system")] = None, **kwargs) -> MerchantResponse:  # noqa: E501
        """Update merchant by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_merchant(merchant_id, merchant_input_request, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the update_merchant_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.update_merchant_with_http_info(merchant_id, merchant_input_request, **kwargs)  # noqa: E501

    @validate_arguments
    def update_merchant_with_http_info(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], merchant_input_request : Annotated[Optional[MerchantInputRequest], Field(description="Merchant to update in system")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Update merchant by ID  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.update_merchant_with_http_info(merchant_id, merchant_input_request, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_merchant" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
