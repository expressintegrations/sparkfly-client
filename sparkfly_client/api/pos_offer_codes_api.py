...
class POSOfferCodesApi:
    ...
    @validate_arguments
    def get_pos_offer_code(self, pos_offer_code_id : Annotated[StrictInt, Field(..., description="The id of the POS Offer Code")], **kwargs) -> PosOfferCodeResponse:  # noqa: E501
        """Get POS Offer Code  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pos_offer_code(pos_offer_code_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_pos_offer_code_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_pos_offer_code_with_http_info(pos_offer_code_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_pos_offer_code_with_http_info(self, pos_offer_code_id : Annotated[StrictInt, Field(..., description="The id of the POS Offer Code")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get POS Offer Code  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pos_offer_code_with_http_info(pos_offer_code_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_pos_offer_code" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
    ...
    @validate_arguments
    def get_pos_offer_codes(self, **kwargs) -> PosOfferCodeList:  # noqa: E501
        """List POS Offer Codes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pos_offer_codes(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_pos_offer_codes_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_pos_offer_codes_with_http_info(**kwargs)  # noqa: E501

    @validate_arguments
    def get_pos_offer_codes_with_http_info(self, **kwargs) -> ApiResponse:  # noqa: E501
        """List POS Offer Codes  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_pos_offer_codes_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_pos_offer_codes" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
