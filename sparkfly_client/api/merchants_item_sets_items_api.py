...
class MerchantsItemSetsItemsApi:
    ...
    @validate_arguments
    def get_merchant_item_set_items(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], item_set_id : Annotated[StrictInt, Field(..., description="The id of the item set")], **kwargs) -> ItemListResponse:  # noqa: E501
        """Get items for item set for merchant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_merchant_item_set_items(merchant_id, item_set_id, async_req=True)
        >>> result = thread.get()
        ...
        if '_preload_content' in kwargs:
            message = "Error! Please call the get_merchant_item_set_items_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.get_merchant_item_set_items_with_http_info(merchant_id, item_set_id, **kwargs)  # noqa: E501

    @validate_arguments
    def get_merchant_item_set_items_with_http_info(self, merchant_id : Annotated[StrictInt, Field(..., description="The id of the merchant")], item_set_id : Annotated[StrictInt, Field(..., description="The id of the item set")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get items for item set for merchant  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.get_merchant_item_set_items_with_http_info(merchant_id, item_set_id, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    ...
                    " to method get_merchant_item_set_items" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
